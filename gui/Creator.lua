...
UIGradient_2.Transparency =
	NumberSequence.new({ NumberSequenceKeypoint.new(0, 0), NumberSequenceKeypoint.new(1, 0.24375) })
...
UIGradient_3.Transparency = NumberSequence.new({
	NumberSequenceKeypoint.new(0, 0.48375),
	NumberSequenceKeypoint.new(0.501, 0),
	NumberSequenceKeypoint.new(1, 0.49375),
})
